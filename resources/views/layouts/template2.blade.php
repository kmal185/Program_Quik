...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body style="font-size:80%; background-image: url('img/fondo.jpg');">
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">Cargue de archivos</h1><br>
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item"><a href="{{route('dashboard')}}">Inicio </a></li>|
                            <br>
                            <li class="breadcrumb-item active"> Cargue de archivos</li>
                        </ol>
                        <form method="post" action="{{ route('empleados.importar') }}" enctype="multipart/form-data">
                            @csrf
                        <div class="card mb-4">
                            <div class="card-body">
                                Señor usuario por favor seleccionar el nombre del empleado que va a cargar informacion.
                        <br>
                            </div>
